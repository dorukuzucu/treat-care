...
public enum PointEnum {
    ...
    DC_POINT ("DC Point","Dc",-18,-20,Color.RED),
    ...
    PM_POINT ("PM point","Pm",8,-10,Color.RED),
    ...
    SIGMOID_NOTCH("Sigmoid Notch","R3", -8,-20,Color.RED),
    MOST_CONVEX_POINT_OF_RAMUS("Most Convex Point of Inner Ramus","R1", -8,-20,Color.RED),
    MOST_EXTERIOR_POINT_OF_RAMUS("Most Exterior Point of Ramus","R2", -8,-20,Color.RED),
    MOST_BOTTOM_POINT_OF_RAMUS("Bottommost Point of Ramus","R4", -8,-20,Color.RED),
