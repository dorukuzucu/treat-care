...
public class HorizontalPointToLineResult extends BaseResult{
    ...
    public HorizontalPointToLineResult(ImagePoint ruler1point ,ImagePoint ruler2point,ImagePoint startPointLine, ImagePoint EndPointLine,
